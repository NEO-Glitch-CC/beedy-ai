...
export function MarqueeAnimation() {
  return (
    <div className="relative flex w-full flex-col items-center justify-center overflow-hidden">
      ...
      <div className="from-white via-white to-transparent pointer-events-none absolute z-10 inset-y-0 right-0 w-1/2 bg-linear-to-l"></div>
      <div className="from-white via-white to-transparent pointer-events-none absolute z-12 inset-y-0 left-0 w-1/2 bg-linear-to-r"></div>
      <div className="from-white via-white to-transparent pointer-events-none absolute z-12 inset-y-0 right-0 w-1/2 bg-linear-to-l"></div>
    </div>
  )
}
